...
export declare type PreHookHandlerType<T extends Result, K = unknown> = (data: T | Partial<T>, actor: Actor, helpers: TaskHookHandlerHelpers, extraData?: K) => Promise<void> | void;
export declare type PostHookHandlerType<T extends Result, K = unknown> = (data: T | T[], actor: Actor, helpers: TaskHookHandlerHelpers, extraData?: K) => Promise<void> | void;
